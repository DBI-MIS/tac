            ...
            <div class="h-auto w-full flex flex-row justify-end">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @mouseleave="open = false" >
                        ...
                        class="absolute left-0 top-10 mt-5 bg-white text-gray-800 rounded shadow-lg z-20"
                        >
                            <x-nav-link   
                            :href="route('projects.index')"
                            :active="request()->routeIs('projects.index')" 
                            class="block px-4 py-2 hover:bg-gray-200 text-nowrap rounded-md shadow-md"
                            wire:navigate>
                            TICA Projects
                            </x-nav-link>
                        </div>
