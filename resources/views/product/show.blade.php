...
<x-app-layout :title="$product->title">
    ...
    <article class="col-span-8 md:col-span-3 md:mt-10 mx-auto py-5 w-full h-full" style="max-width:900px">
        ...
        style="min-width:280px; max-width:auto"
        >
        ...
        <div class="grid grid-cols-3 gap-3 flex-grow">        
            <div class="col-span-3 w-full py-5 px-5 mb-5 rounded-xl border-l-4 border-opacity-10 p-2 bg-white border-blue-800">
                ...
                <div class="flex flex-row justify-between w-full">
                    ...
                    <div class="mb-2 text-base items-center justify-between border-t border-b border-gray-100 px-2 text-wrap">
                    ...
                    {{-- <x-filament::modal width="2xl">
                        ...
                        <livewire:product-response :product_id="$product->title"/>
                    </x-filament::modal>
                    --}}
        ...
        <div class="flex flex-col md:flex-row md:items-center items-start gap-5 w-full justify-between py-4 px-5 md:px-10 border-y-2 border-blue-200 mt-24">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <div>
                  ...
                  <div><a href="https://www.facebook.com/teamasiacorporation" target="_blank" rel="noreferer">TAC</a></div>
                ...
                <div class="flex gap-1 mt-1">
                    ...
                    <div><a href="https://www.linkedin.com/in/team-asia-corporation-9a89b01a9/" target="_blank" rel="noreferer">TAC</a></div> 
                </div>
                </div>
            </div>
