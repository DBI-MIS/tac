    ...
    <div class="flex flex-row relative w-full ">
        ...
        <div id="productContainer"
            ...
            <div class=" w-full flex flex-row gap-4 justify-between">
                @foreach ($featuredCocokings as $featuredcocoking)
                    <x-page.featured-cocoking :featuredcocoking="$featuredcocoking" />
                @endforeach
                <div
                    ...
                    <div class="text-balance flex flex-col items-center mb-2" wire:navigate
                        href="{{ route('organicproducts.index') }}?organiccategory=cocoking">
