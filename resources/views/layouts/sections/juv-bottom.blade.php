<section
    ...
    style="background-image: url('{{ $juvPages['juv_bottom']?->img_page ? asset('storage/' . $juvPages['juv_bottom']->img_page) : asset('/default-slide-2.webp') }}')">
    ...
    <div
        ...
        <div class="col-span-2 ">
            <h1 class="text-3xl lg:text-5xl font-bold  tracking-wide leading-tight drop-shadow-md text-white ">
                {{ $juvPages['juv_bottom']->title ?? 'No Data' }}
            </h1>
            <p class="max-w-xl mt-4 text-md md:text-lg  text-white drop-shadow-md">
                {{ $juvPages['juv_bottom']->description1 ?? 'No Data' }}
            </p>
