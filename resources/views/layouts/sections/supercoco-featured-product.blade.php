<div class="flex flex-col">
    <div class="w-full rounded-b-xl overflow-hidden">
        <img src="{{ asset('supercollage.webp') }}" alt="Supercoco Product Collage" class="w-full h-auto">
    </div>
    ...
    <div class="flex flex-row relative w-full ">
        ...
        <div id="productContainer"
            ...
            <div class=" w-full flex flex-row gap-4 justify-between">
                @foreach ($featuredSupercocos as $featuredsupercoco)
                <x-page.featured-supercoco :featuredsupercoco="$featuredsupercoco" />
                @endforeach
                <div
                    ...
                    <div class="text-balance flex flex-col items-center mb-2" wire:navigate
                        href="{{ route('organicproducts.index') }}?organiccategory=supercoco">
