            ...
            <x-filament::modal width="2xl" wire:ignore.self>
                ...
                <div class="relative" x-data="{ open: true }">
                    <div x-show="open" class="p-6 border-b border-gray-200">
                        <h2 class="text-2xl text-gray-600 font-semibold mb-4">Send Us a Message</h2>
                        <div class="flex flex-row  md:space-x-6 mb-4">
                            <div class="flex items-center mb-4 md:mb-0">
                                ...
                                <span class="text-gray-800 text-base">reception@dbiphils.com</span>
                            </div>
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-800 text-base">(+632) 8723-4461 to 64</span>
                            </div>
                        </div>
                    </div>
